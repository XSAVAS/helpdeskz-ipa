    ...
    public function create()
    {
        ...
        if ($this->request->getPost('do') == 'submit') {
            ...
            if ($validation->withRequest($this->request)->run() == false) {
                ...
                $this->session->setFlashdata('form_success', lang('Admin.tickets.ticketCreated'));
    ...
    public function cannedResponses()
    {
        ...
        if ($this->request->getPost('do') == 'remove') {
            if (!$canned = $tickets->getCannedResponse($this->request->getPost('msgID'))) {
                ...
                $this->session->setFlashdata('canned_update', lang('Admin.cannedResponses.cannedRemoved'));
    ...
    public function editCannedResponses($canned_id)
    {
        ...
        if ($this->request->getPost('do') == 'submit') {
            ...
            if ($validation->withRequest($this->request)->run() == false) {
                ...
                $this->session->setFlashdata('canned_update', lang('Admin.cannedResponses.cannedUpdated'));
                return redirect()->to(current_url());
            }
        }
    ...
    public function newCannedResponse()
    {
        if ($this->request->getPost('do') == 'submit') {
            ...
            if ($validation->withRequest($this->request)->run() == false) {
                ...
                $this->session->setFlashdata('canned_update', lang('Admin.cannedResponses.cannedInserted'));
                return redirect()->route('staff_canned');
            }
        }
